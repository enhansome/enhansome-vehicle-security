...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,644 | 🐛 6 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,480 | 🐛 7 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,644 | 🐛 6 | 📅 2026-05-30!
...
* [PiCCANTE](https://github.com/Alia5/PiCCANTE) ⭐ 95 | 🐛 13 | 🌐 C++ | 📅 2026-01-26 - Open-source CAN hacking tool based on Raspberry Pi Pico \[2] (W) - Up to 3x CAN interfaces, includes ELM327 emulator.
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,733 | 🐛 138 | 🌐 Python | 📅 2026-09-25 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
* [openalpr](https://github.com/openalpr/openalpr) ⭐ 11,462 | 🐛 519 | 🌐 C++ | 📅 2024-01-11 - An open source Automatic License Plate Recognition library written in C++ with bindings in C#, Java, Node.js, Go, and Python.
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,084 | 🐛 67 | 🌐 C | 📅 2026-09-24 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
[Custom Applications SDK for Mazda Connect Infotainment System](https://github.com/flyandi/mazda-custom-application-sdk) ⭐ 211 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-22 - A micro framework that allows you to write and deploy custom applications for the Mazda Infotainment System.

### C

* [SocketCAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,922 | 🐛 61 | 🌐 C | 📅 2026-09-20 - Userspace utilites for SocketCAN on Linux.
...
* [UnlockECU](https://github.com/jglim/UnlockECU) ⭐ 449 | 🐛 20 | 🌐 C# | 📅 2026-06-04 - Free, open-source ECU seed-key unlocking tool.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,565 | 🐛 138 | 🌐 Python | 📅 2026-09-23 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,289 | 🐛 131 | 🌐 Python | 📅 2026-09-16 Python module to decode and encode CAN messages using a DBC file
* [Python-CAN](https://github.com/hardbyte/python-can) ⭐ 1,600 | 🐛 281 | 🌐 Python | 📅 2026-07-01 - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 221 | 🐛 118 | 🌐 Python | 📅 2026-09-25 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 10 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
...
* [canarchy](https://github.com/hexsecs/canarchy) ⭐ 4 | 🐛 15 | 🌐 Python | 📅 2026-09-24 - CANarchy is a stream-first CAN analysis and manipulation runtime designed for automation, security research, and agent-driven workflows.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,864 | 🐛 68 | 🌐 JavaScript | 📅 2024-07-22
  ...
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,064 | 🐛 43 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,364 | 🐛 107 | 📅 2026-09-02
  * [lists](https://github.com/jnv/lists) ⭐ 11,506 | 🐛 30 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,644 | 🐛 6 | 📅 2026-05-30 first.
