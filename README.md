...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,543 | 🐛 3 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,443 | 🐛 6 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,543 | 🐛 3 | 📅 2026-05-30!
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,554 | 🐛 137 | 🌐 Python | 📅 2026-09-02 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
...
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,042 | 🐛 64 | 🌐 C | 📅 2026-08-31 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 35 | 🐛 3 | 📅 2026-02-27 - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
* [SocketCAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,911 | 🐛 64 | 🌐 C | 📅 2026-05-12 - Userspace utilites for SocketCAN on Linux.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,513 | 🐛 149 | 🌐 Python | 📅 2026-09-02 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
...
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 8 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 214 | 🐛 173 | 🌐 Python | 📅 2026-09-02 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
...
* [NodeJS extension to SocketCAN](https://github.com/sebi2k1/node-can) ⭐ 247 | 🐛 6 | 🌐 C++ | 📅 2026-08-31 - Allows you to communicate over CAN networks with simple JavaScript functions.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,820 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22
...
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,329 | 🐛 105 | 📅 2026-09-02
  * [lists](https://github.com/jnv/lists) ⭐ 11,454 | 🐛 24 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,543 | 🐛 3 | 📅 2026-05-30 first.
