# Awesome Vehicle Security with stars
...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,621 | 🐛 3 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,464 | 🐛 6 | 📅 2026-08-07
...
* [Udacity's Self Driving Car Engineer Course](https://github.com/udacity/self-driving-car) ⚠️ Archived - The content for Udacity's self driving car software engineer course. The actual course on Udacity's website is [here](https://www.udacity.com/course/self-driving-car-engineer-nanodegree--nd013).
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,621 | 🐛 3 | 📅 2026-05-30!
...
* [Reverse Engineering Resources](https://github.com/ps1337/automotive-security-research) ⭐ 103 | 🐛 0 | 🌐 Python | 📅 2019-05-26
...
* [Open Source Car Control Project](https://github.com/PolySync/OSCC) ⭐ 1,039 | 🐛 15 | 🌐 C++ | 📅 2019-12-10 - The Open Source Car Control Project is a hardware and software project detailing the conversion of a late model vehicle into an autonomous driving research and development vehicle.
* [Open Vehicle Monitoring System](https://github.com/openvehicles/Open-Vehicle-Monitoring-System) ⭐ 348 | 🐛 9 | 🌐 C | 📅 2021-08-07 - A community project building a hardware module for your car, a server to talk to it, and a mobile app to talk to the server, in order to allow developers and enthusiasts to add more functionality to their car and control it remotely.
...
* [PiCCANTE](https://github.com/Alia5/PiCCANTE) ⭐ 93 | 🐛 12 | 🌐 C++ | 📅 2026-01-26 - Open-source CAN hacking tool based on Raspberry Pi Pico \[2] (W) - Up to 3x CAN interfaces, includes ELM327 emulator.
* [Arduino](https://www.arduino.cc/) - Arduino boards have a number of shields you can attach to connect to CAN-enabled devices.
  * [arduino-canbus-monitor](https://github.com/latonita/arduino-canbus-monitor) ⭐ 336 | 🐛 4 | 🌐 C++ | 📅 2025-10-22 - No matter which shield is selected you will need your own sniffer. This is implementation of standard Lawicel/SLCAN protocol for Arduino + any MCP CAN Shield to use with many standard CAN bus analysis software packages or SocketCAN
  * [CANdiy-Shield](https://github.com/watterott/CANdiy-Shield) ⭐ 28 | 🐛 0 | 📅 2019-11-21
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,651 | 🐛 136 | 🌐 Python | 📅 2026-09-14 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
* [openalpr](https://github.com/openalpr/openalpr) ⭐ 11,456 | 🐛 520 | 🌐 C++ | 📅 2024-01-11 - An open source Automatic License Plate Recognition library written in C++ with bindings in C#, Java, Node.js, Go, and Python.
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,071 | 🐛 68 | 🌐 C | 📅 2026-08-31 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [UDSim](https://github.com/zombieCraig/UDSim/) ⭐ 336 | 🐛 4 | 🌐 C++ | 📅 2022-12-10 - GUI tool that can monitor a CAN bus and automatically learn the devices attached to it by watching communications.
...
* [mazda\_getInfo](https://github.com/shipcod3/mazda_getInfo) ⭐ 166 | 🐛 0 | 🌐 Shell | 📅 2022-05-31 - A PoC that the USB port is an attack surface for a Mazda car's infotainment system and how Mazda hacks are made (known bug in the CMU).
* [talking-with-cars](https://github.com/P1kachu/talking-with-cars) ⭐ 134 | 🐛 0 | 🌐 Python | 📅 2021-10-11 - CAN related scripts, and scripts to use a car as a gamepad
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 38 | 🐛 3 | 📅 2026-02-27 - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
[Custom Applications SDK for Mazda Connect Infotainment System](https://github.com/flyandi/mazda-custom-application-sdk) ⭐ 210 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-22 - A micro framework that allows you to write and deploy custom applications for the Mazda Infotainment System.

### C

* [SocketCAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,911 | 🐛 61 | 🌐 C | 📅 2026-05-12 - Userspace utilites for SocketCAN on Linux.
* [dbcc](https://github.com/howerj/dbcc) ⭐ 458 | 🐛 1 | 🌐 C | 📅 2025-10-07 - "dbcc is a program for converting a DBC file primarily into into C code that can serialize and deserialize CAN messages." With existing DBC files from a vehicle, this file allows you to convert them to C code that extracts the CAN messages and properties of the CAN environment.
* [vircar](https://github.com/dn5/vircar) ⭐ 158 | 🐛 2 | 🌐 C | 📅 2020-09-07 - a Virtual car userspace that sends CAN messages based on SocketCAN

### C++

* [CANdevStudio](https://github.com/GENIVI/CANdevStudio) ⭐ 1,142 | 🐛 37 | 🌐 C++ | 📅 2025-07-21 - Development tool for CAN bus simulation. CANdevStudio enables to simulate CAN signals such as ignition status, doors status or reverse gear by every automotive developer.
* [UnlockECU](https://github.com/jglim/UnlockECU) ⭐ 445 | 🐛 20 | 🌐 C# | 📅 2026-06-04 - Free, open-source ECU seed-key unlocking tool.
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 9 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
...
* [ITS Geonetworking](https://github.com/alexvoronov/geonetworking) ⭐ 110 | 🐛 3 | 🌐 Java | 📅 2023-11-29 - ETSI ITS G5 GeoNetworking stack, in Java: CAM-DENM / ASN.1 PER / BTP / GeoNetworking

### Python

* [Scapy](https://github.com/secdev/scapy) ⭐ 12,544 | 🐛 138 | 🌐 Python | 📅 2026-09-12 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,285 | 🐛 130 | 🌐 Python | 📅 2026-09-11 Python module to decode and encode CAN messages using a DBC file
* [Python-CAN](https://github.com/hardbyte/python-can) ⭐ 1,595 | 🐛 277 | 🌐 Python | 📅 2026-07-01 - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
* [Python-OBD](https://github.com/brendan-w/python-OBD) ⭐ 1,313 | 🐛 95 | 🌐 Python | 📅 2025-04-07 - A Python module for handling realtime sensor data from OBD-II vehicle ports. Works with ELM327 OBD-II adapters, and is fit for the Raspberry Pi.
* [canmatrix](https://github.com/ebroecker/canmatrix) ⭐ 1,088 | 🐛 21 | 🌐 Python | 📅 2026-08-17 Python module to work with CAN matrix files
* [Caring Caribou](https://github.com/CaringCaribou/caringcaribou/) ⭐ 950 | 🐛 14 | 🌐 Python | 📅 2026-06-12 - Intended to be the *nmap of vehicle security*.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 219 | 🐛 171 | 🌐 Python | 📅 2026-09-14 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 9 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [canTot](https://github.com/shipcod3/canTot) ⭐ 150 | 🐛 2 | 🌐 Python | 📅 2024-10-15 - A python-based cli framework based on sploitkit and is easy to use because it similar to working with Metasploit. This similar to an exploit framework but focused on known CAN Bus vulnerabilities or fun CAN Bus hacks.
* [c0f](https://github.com/zombieCraig/c0f/) ⭐ 95 | 🐛 1 | 🌐 Ruby | 📅 2015-09-29 - A fingerprinting tool for CAN communications that can be used to find a specific signal on a CAN network when testing interactions with a vehicle.
* [Caring Caribou Next](https://github.com/Cr0wTom/caringcaribounext) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2024-03-13 - Upgraded and optimized version of the original Caring Caribou project.
* [canarchy](https://github.com/hexsecs/canarchy) ⭐ 3 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - CANarchy is a stream-first CAN analysis and manipulation runtime designed for automation, security research, and agent-driven workflows.
...
* [CANNiBUS](https://github.com/Hive13/CANiBUS/) ⚠️ Archived - A Go server that allows a room full of researchers to simultaneously work on the same vehicle, whether for instructional purposes or team reversing sessions.
* [CAN Simulator](https://github.com/carloop/simulator-program) ⭐ 69 | 🐛 1 | 🌐 Go | 📅 2016-06-02 - A Go based CAN simulator for the Raspberry Pi to be used with PiCAN2 or the open source [CAN Simulator board](https://github.com/carloop/simulator) ⭐ 189 | 🐛 4 | 📅 2018-06-03

### JavaScript

* [NodeJS extension to SocketCAN](https://github.com/sebi2k1/node-can) ⭐ 248 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-14 - Allows you to communicate over CAN networks with simple JavaScript functions.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,845 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22
  ...
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,056 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,010 | 🐛 106 | 📅 2026-09-02
  * [lists](https://github.com/jnv/lists) ⭐ 11,480 | 🐛 27 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,621 | 🐛 3 | 📅 2026-05-30 first.
