...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,631 | 🐛 5 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,472 | 🐛 7 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,631 | 🐛 5 | 📅 2026-05-30!
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,693 | 🐛 143 | 🌐 Python | 📅 2026-09-20 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
...
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,080 | 🐛 70 | 🌐 C | 📅 2026-08-31 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [UDSim](https://github.com/zombieCraig/UDSim/) ⭐ 337 | 🐛 4 | 🌐 C++ | 📅 2022-12-10 - GUI tool that can monitor a CAN bus and automatically learn the devices attached to it by watching communications.
...
* [UnlockECU](https://github.com/jglim/UnlockECU) ⭐ 447 | 🐛 20 | 🌐 C# | 📅 2026-06-04 - Free, open-source ECU seed-key unlocking tool.
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 10 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,558 | 🐛 141 | 🌐 Python | 📅 2026-09-20 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,287 | 🐛 129 | 🌐 Python | 📅 2026-09-16 Python module to decode and encode CAN messages using a DBC file
* [Python-CAN](https://github.com/hardbyte/python-can) ⭐ 1,598 | 🐛 279 | 🌐 Python | 📅 2026-07-01 - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 220 | 🐛 158 | 🌐 Python | 📅 2026-09-18 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 10 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
...
* [canarchy](https://github.com/hexsecs/canarchy) ⭐ 4 | 🐛 8 | 🌐 Python | 📅 2026-09-19 - CANarchy is a stream-first CAN analysis and manipulation runtime designed for automation, security research, and agent-driven workflows.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,861 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22
  * [Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,563 | 🐛 29 | 🌐 Python | 📅 2026-06-01
  * [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,702 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07
  * [Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,400 | 🐛 83 | 📅 2026-07-15
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,064 | 🐛 42 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,158 | 🐛 106 | 📅 2026-09-02
  * [lists](https://github.com/jnv/lists) ⭐ 11,501 | 🐛 27 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,631 | 🐛 5 | 📅 2026-05-30 first.
