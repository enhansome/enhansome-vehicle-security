...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,447 | 🐛 2 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,420 | 🐛 5 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,447 | 🐛 2 | 📅 2026-05-30!
...
* [PiCCANTE](https://github.com/Alia5/PiCCANTE) ⭐ 91 | 🐛 12 | 🌐 C++ | 📅 2026-01-26 - Open-source CAN hacking tool based on Raspberry Pi Pico \[2] (W) - Up to 3x CAN interfaces, includes ELM327 emulator.
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,432 | 🐛 120 | 🌐 Python | 📅 2026-08-17 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
* [openalpr](https://github.com/openalpr/openalpr) ⭐ 11,444 | 🐛 521 | 🌐 C++ | 📅 2024-01-11 - An open source Automatic License Plate Recognition library written in C++ with bindings in C#, Java, Node.js, Go, and Python.
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,005 | 🐛 61 | 🌐 C | 📅 2026-08-11 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [talking-with-cars](https://github.com/P1kachu/talking-with-cars) ⭐ 133 | 🐛 0 | 🌐 Python | 📅 2021-10-11 - CAN related scripts, and scripts to use a car as a gamepad
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 33 | 🐛 3 | 📅 2026-02-27 - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
[Custom Applications SDK for Mazda Connect Infotainment System](https://github.com/flyandi/mazda-custom-application-sdk) ⭐ 207 | 🐛 0 | 🌐 JavaScript | 📅 2016-09-22 - A micro framework that allows you to write and deploy custom applications for the Mazda Infotainment System.

### C

* [SocketCAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,903 | 🐛 62 | 🌐 C | 📅 2026-05-12 - Userspace utilites for SocketCAN on Linux.
...
* [UnlockECU](https://github.com/jglim/UnlockECU) ⭐ 440 | 🐛 19 | 🌐 C# | 📅 2026-06-04 - Free, open-source ECU seed-key unlocking tool.
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 217 | 🐛 7 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,475 | 🐛 131 | 🌐 Python | 📅 2026-08-16 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,267 | 🐛 127 | 🌐 Python | 📅 2026-08-17 Python module to decode and encode CAN messages using a DBC file
* [Python-CAN](https://github.com/hardbyte/python-can) ⭐ 1,582 | 🐛 268 | 🌐 Python | 📅 2026-07-01 - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
...
* [canmatrix](https://github.com/ebroecker/canmatrix) ⭐ 1,086 | 🐛 20 | 🌐 Python | 📅 2026-08-17 Python module to work with CAN matrix files
* [Caring Caribou](https://github.com/CaringCaribou/caringcaribou/) ⭐ 942 | 🐛 14 | 🌐 Python | 📅 2026-06-12 - Intended to be the *nmap of vehicle security*.
...
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 217 | 🐛 7 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 211 | 🐛 179 | 🌐 Python | 📅 2026-08-17 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
...
* [Caring Caribou Next](https://github.com/Cr0wTom/caringcaribounext) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2024-03-13 - Upgraded and optimized version of the original Caring Caribou project.
...
* [NodeJS extension to SocketCAN](https://github.com/sebi2k1/node-can) ⭐ 245 | 🐛 6 | 🌐 C++ | 📅 2026-08-15 - Allows you to communicate over CAN networks with simple JavaScript functions.
...
* Security
  * [Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 16,890 | 🐛 68 | 📅 2024-06-02
  * [Security](https://github.com/sbilly/awesome-security) ⭐ 14,757 | 🐛 307 | 📅 2026-01-11
  * [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,129 | 🐛 25 | 📅 2024-06-07
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,760 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22
  ...
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,030 | 🐛 40 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,843 | 🐛 100 | 📅 2026-06-30
  * [lists](https://github.com/jnv/lists) ⭐ 11,423 | 🐛 19 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,447 | 🐛 2 | 📅 2026-05-30 first.
