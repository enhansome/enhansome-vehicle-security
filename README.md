...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,511 | 🐛 2 | 📅 2026-05-30
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,511 | 🐛 2 | 📅 2026-05-30!
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,481 | 🐛 131 | 🌐 Python | 📅 2026-08-24 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
* [openalpr](https://github.com/openalpr/openalpr) ⭐ 11,448 | 🐛 521 | 🌐 C++ | 📅 2024-01-11 - An open source Automatic License Plate Recognition library written in C++ with bindings in C#, Java, Node.js, Go, and Python.
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,016 | 🐛 64 | 🌐 C | 📅 2026-08-23 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [UnlockECU](https://github.com/jglim/UnlockECU) ⭐ 442 | 🐛 20 | 🌐 C# | 📅 2026-06-04 - Free, open-source ECU seed-key unlocking tool.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,494 | 🐛 134 | 🌐 Python | 📅 2026-08-18 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
...
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 217 | 🐛 7 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 211 | 🐛 166 | 🌐 Python | 📅 2026-08-24 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
...
* [NodeJS extension to SocketCAN](https://github.com/sebi2k1/node-can) ⭐ 246 | 🐛 6 | 🌐 C++ | 📅 2026-08-15 - Allows you to communicate over CAN networks with simple JavaScript functions.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,791 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22
...
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,508 | 🐛 106 | 📅 2026-08-21
  * [lists](https://github.com/jnv/lists) ⭐ 11,436 | 🐛 21 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,511 | 🐛 2 | 📅 2026-05-30 first.
