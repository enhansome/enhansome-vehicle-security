...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,444 | 🐛 2 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,413 | 🐛 5 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,444 | 🐛 2 | 📅 2026-05-30!
...
* [Arduino](https://www.arduino.cc/) - Arduino boards have a number of shields you can attach to connect to CAN-enabled devices.
  * [arduino-canbus-monitor](https://github.com/latonita/arduino-canbus-monitor) ⭐ 335 | 🐛 4 | 🌐 C++ | 📅 2025-10-22 - No matter which shield is selected you will need your own sniffer. This is implementation of standard Lawicel/SLCAN protocol for Arduino + any MCP CAN Shield to use with many standard CAN bus analysis software packages or SocketCAN
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,420 | 🐛 124 | 🌐 Python | 📅 2026-08-15 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
...
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 999 | 🐛 60 | 🌐 C | 📅 2026-08-11 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [CANdevStudio](https://github.com/GENIVI/CANdevStudio) ⭐ 1,138 | 🐛 37 | 🌐 C++ | 📅 2025-07-21 - Development tool for CAN bus simulation. CANdevStudio enables to simulate CAN signals such as ignition status, doors status or reverse gear by every automotive developer.
...
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,267 | 🐛 128 | 🌐 Python | 📅 2026-08-14 Python module to decode and encode CAN messages using a DBC file
* [Python-CAN](https://github.com/hardbyte/python-can) ⭐ 1,582 | 🐛 267 | 🌐 Python | 📅 2026-07-01 - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
...
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 217 | 🐛 7 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 211 | 🐛 179 | 🌐 Python | 📅 2026-08-14 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
...
* Security
  ...
  * [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,122 | 🐛 25 | 📅 2024-06-07
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,754 | 🐛 64 | 🌐 JavaScript | 📅 2024-07-22
  ...
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,026 | 🐛 40 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,003 | 🐛 100 | 📅 2026-06-30
  * [lists](https://github.com/jnv/lists) ⭐ 11,419 | 🐛 19 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,444 | 🐛 2 | 📅 2026-05-30 first.
