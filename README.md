...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,544 | 🐛 3 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,445 | 🐛 6 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,544 | 🐛 3 | 📅 2026-05-30!
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,559 | 🐛 136 | 🌐 Python | 📅 2026-09-03 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,517 | 🐛 150 | 🌐 Python | 📅 2026-09-03 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
...
* [Python-CAN](https://github.com/hardbyte/python-can) ⭐ 1,587 | 🐛 275 | 🌐 Python | 📅 2026-07-01 - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
...
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 9 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 215 | 🐛 179 | 🌐 Python | 📅 2026-09-03 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
...
* [canarchy](https://github.com/hexsecs/canarchy) ⭐ 3 | 🐛 7 | 🌐 Python | 📅 2026-09-03 - CANarchy is a stream-first CAN analysis and manipulation runtime designed for automation, security research, and agent-driven workflows.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,823 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22
  ...
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,050 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,644 | 🐛 105 | 📅 2026-09-02
  * [lists](https://github.com/jnv/lists) ⭐ 11,454 | 🐛 24 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,544 | 🐛 3 | 📅 2026-05-30 first.
