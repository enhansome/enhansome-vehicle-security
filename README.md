...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,625 | 🐛 5 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,469 | 🐛 7 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,625 | 🐛 5 | 📅 2026-05-30!
...
* [PiCCANTE](https://github.com/Alia5/PiCCANTE) ⭐ 94 | 🐛 12 | 🌐 C++ | 📅 2026-01-26 - Open-source CAN hacking tool based on Raspberry Pi Pico \[2] (W) - Up to 3x CAN interfaces, includes ELM327 emulator.
* [Arduino](https://www.arduino.cc/) - Arduino boards have a number of shields you can attach to connect to CAN-enabled devices.
  * [arduino-canbus-monitor](https://github.com/latonita/arduino-canbus-monitor) ⭐ 337 | 🐛 4 | 🌐 C++ | 📅 2025-10-22 - No matter which shield is selected you will need your own sniffer. This is implementation of standard Lawicel/SLCAN protocol for Arduino + any MCP CAN Shield to use with many standard CAN bus analysis software packages or SocketCAN
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,671 | 🐛 143 | 🌐 Python | 📅 2026-09-17 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
* [openalpr](https://github.com/openalpr/openalpr) ⭐ 11,458 | 🐛 520 | 🌐 C++ | 📅 2024-01-11 - An open source Automatic License Plate Recognition library written in C++ with bindings in C#, Java, Node.js, Go, and Python.
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,078 | 🐛 69 | 🌐 C | 📅 2026-08-31 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 38 | 🐛 4 | 📅 2026-02-27 - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
* [SocketCAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,916 | 🐛 61 | 🌐 C | 📅 2026-05-12 - Userspace utilites for SocketCAN on Linux.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,549 | 🐛 139 | 🌐 Python | 📅 2026-09-16 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,285 | 🐛 127 | 🌐 Python | 📅 2026-09-16 Python module to decode and encode CAN messages using a DBC file
* [Python-CAN](https://github.com/hardbyte/python-can) ⭐ 1,597 | 🐛 278 | 🌐 Python | 📅 2026-07-01 - Python interface to various CAN implementations, including SocketCAN. Allows you to use Python 2.7.x or 3.3.x+ to communicate over CAN networks.
...
* [canmatrix](https://github.com/ebroecker/canmatrix) ⭐ 1,089 | 🐛 21 | 🌐 Python | 📅 2026-08-17 Python module to work with CAN matrix files
...
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 219 | 🐛 174 | 🌐 Python | 📅 2026-09-17 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 9 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
...
* [canarchy](https://github.com/hexsecs/canarchy) ⭐ 4 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - CANarchy is a stream-first CAN analysis and manipulation runtime designed for automation, security research, and agent-driven workflows.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,857 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22
  * [Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,562 | 🐛 26 | 🌐 Python | 📅 2026-06-01
  * [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,698 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07
  * [Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,393 | 🐛 82 | 📅 2026-07-15
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,060 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,097 | 🐛 106 | 📅 2026-09-02
  * [lists](https://github.com/jnv/lists) ⭐ 11,487 | 🐛 27 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,625 | 🐛 5 | 📅 2026-05-30 first.
