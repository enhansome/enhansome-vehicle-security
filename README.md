...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,612 | 🐛 3 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,461 | 🐛 6 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,612 | 🐛 3 | 📅 2026-05-30!
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,647 | 🐛 139 | 🌐 Python | 📅 2026-09-13 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
...
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 1,068 | 🐛 67 | 🌐 C | 📅 2026-08-31 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 37 | 🐛 3 | 📅 2026-02-27 - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
* [SocketCAN Utils](https://github.com/linux-can/can-utils) ⭐ 2,912 | 🐛 61 | 🌐 C | 📅 2026-05-12 - Userspace utilites for SocketCAN on Linux.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,542 | 🐛 138 | 🌐 Python | 📅 2026-09-12 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
...
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 218 | 🐛 9 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 218 | 🐛 173 | 🌐 Python | 📅 2026-09-12 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
...
* Security
  ...
  * [Capture the Flag](https://github.com/apsdehal/awesome-ctf) ⭐ 11,844 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22
  * [Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,557 | 🐛 25 | 🌐 Python | 📅 2026-06-01
  * [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,688 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07
  * [Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,383 | 🐛 82 | 📅 2026-07-15
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,055 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,676 | 🐛 106 | 📅 2026-09-02
  * [lists](https://github.com/jnv/lists) ⭐ 11,477 | 🐛 27 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,612 | 🐛 3 | 📅 2026-05-30 first.
