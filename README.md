...
I would love as much help as I can get. [Start contributing!](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,443 | 🐛 2 | 📅 2026-05-30
...
* [Awesome CAN Bus - an awesome list just for CAN Bus-related tools (hardware, software, etc.)](https://github.com/iDoka/awesome-canbus) ⭐ 3,409 | 🐛 5 | 📅 2026-08-07
...
[Welcoming contributions](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,443 | 🐛 2 | 📅 2026-05-30!
...
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,406 | 🐛 122 | 🌐 Python | 📅 2026-08-14 - openpilot is an open source driving agent that performs the functions of Adaptive Cruise Control (ACC) and Lane Keeping Assist System (LKAS) for Hondas and Acuras.
...
* [Tesla Mod](https://github.com/hypery11/flipper-tesla-fsd) ⭐ 997 | 🐛 60 | 🌐 C | 📅 2026-08-11 - Tesla CAN bus toolkit for Flipper Zero and ESP32. Nag killer, FSD region unlock, track mode, BMS dashboard, blind spot alert, high beam strobe, and 30+ more CAN handlers. Open source (GPL-3.0).
...
* [BlackFlag ECU](https://github.com/bad-antics/blackflag-ecu) ⭐ 32 | 🐛 3 | 📅 2026-02-27 - Professional ECU diagnostics and tuning suite with OBD-II scanning, DTC reading, live sensor monitoring, and reflash capabilities.
...
* [Scapy](https://github.com/secdev/scapy) ⭐ 12,470 | 🐛 132 | 🌐 Python | 📅 2026-08-14 - A python library to send, receive, edit raw packets. Supports CAN and automotive protocols: see the [automotive doc](https://scapy.readthedocs.io/en/latest/layers/automotive.html)
* [cantools](https://github.com/eerimoq/cantools) ⭐ 2,267 | 🐛 127 | 🌐 Python | 📅 2026-08-14 Python module to decode and encode CAN messages using a DBC file
...
* [CanCat](https://github.com/atlas0fd00m/CanCat) ⭐ 217 | 🐛 7 | 🌐 Python | 📅 2023-04-07 - A "swiss-army knife" for interacting with live CAN data. Primary API interface in Python, but written in C++.
* [Jumpstarter](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 210 | 🐛 180 | 🌐 Python | 📅 2026-08-14 - A hardware-in-the-loop testing framework with automotive diagnostic drivers for UDS, DoIP, and CAN bus protocols.
...
* [NodeJS extension to SocketCAN](https://github.com/sebi2k1/node-can) ⭐ 245 | 🐛 11 | 🌐 C++ | 📅 2026-08-10 - Allows you to communicate over CAN networks with simple JavaScript functions.
...
* Security
  ...
  * [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,118 | 🐛 25 | 📅 2024-06-07
  ...
  * [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,608 | 🐛 2 | 🌐 Makefile | 📅 2026-08-10
  * [Incident Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,323 | 🐛 73 | 📅 2026-07-15
  * [Application Security](https://github.com/paragonie/awesome-appsec) ⭐ 7,025 | 🐛 40 | 🌐 PHP | 📅 2025-02-22
* Meta
  * [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,660 | 🐛 100 | 📅 2026-06-30
  * [lists](https://github.com/jnv/lists) ⭐ 11,418 | 🐛 19 | 📅 2026-03-23

# Contributing

Your contributions are always welcome! Please take a look at the [contribution guidelines](https://github.com/jaredmichaelsmith/awesome-vehicle-security/blob/master/contributing.md) ⭐ 4,443 | 🐛 2 | 📅 2026-05-30 first.
